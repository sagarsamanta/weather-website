...
const forecast=(latitude,longitude,callback)=>{
    ...
    request({url:url,json:true},(error,response)=>{
       if(error){
        ...
        const result=response.body.current.weather_descriptions+' .Its currently '+ response.body.current.temperature +' degree out and its feels like '+ response.body.current.feelslike +' degree out';
